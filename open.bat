...
if errorlevel 2 (
    ...
    start "" "%UNZIP_DIR%\Godot_v%VERSION%_win64.exe" --editor --path "%CD%\project"
) else (
    echo "Enable Console Mode..."
    "%UNZIP_DIR%\Godot_v%VERSION%_win64_console.exe" -v -d --editor --path "%CD%\project"
